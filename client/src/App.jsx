...
import RateLimitGuard from "./components/RateLimitGuard.jsx";
import SharedFilePage from "./components/SharedFilePage.jsx";
import SearchShare from "./components/SearchShare.jsx";
          ...
          <div className="flex items-center space-x-3">
            ...
            {loggedIn && (
              <>
                ...
                <NavLink to="/search" className={navLinkClasses}>Search</NavLink>
              ...
              <div className="relative z-10">
                <Routes>
                  ...
                  <Route path="/home" element={
                    <ProtectedRoute><UploadDownloadPage /></ProtectedRoute>
                  } />
                  <Route path="/search" element={
                    <ProtectedRoute><SearchShare /></ProtectedRoute>
                  } />
